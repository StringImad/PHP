...
$contador = 0;
        foreach ($obj->usuario as $tupla) {
            ...
            echo "<input type='hidden' name='numEquipo' value='" . $datos_env["dia"] . "'/>";
            echo "<input type='hidden' name='hora' value='" . $datos_env["hora"] . "'/>";
            echo "<input type='hidden' name='dia' value='" . $_POST["numEquipo"] . "'/>";
        ...
        if (isset($_POST["btnVerProfesor"])) {
            ...
            echo "<td rowspan=".$contador.">Nombre: ".$obj->usuario->nombre ."</td>";
        }

...
if (isset($_POST["btnLogin"])) {
    ...
    if (!$error_usuario && !$error_clave) {
        ...
        if (!$obj) {
            session_destroy();
            die(error_page("Practica 4 - SW", "Practica 4 - SW", "Error consumiendo el servicio: " . $url . $respuesta));
        }

        if (isset($obj->mensaje_error)) {
            session_destroy();
            die(error_page("Practica 4 - SW", "Practica 4 - SW", $obj->mensaje_error));
        }
